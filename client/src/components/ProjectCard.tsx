...
import { EllipsisIcon, ImageIcon, Loader2Icon, PlaySquareIcon, Share2Icon, Space, Trash2Icon } from "lucide-react";
import { GhostButton, PrimaryButton } from "./Buttons";


const ProjectCard = ({gen, setGenerations, forCommunity = false} : 
{gen : Project, setGenerations : React.Dispatch<React.SetStateAction<Project[]>>, forCommunity?: 
boolean}) => {
    ...
    hover:border-white/20 transition group">
        ...
        'aspect-video'} relative overflow-hidden`}>
            ...
            {(!gen?.generatedImage && !gen?.generatedVideo) && (
                <div className="absolute insert-0 w-full flex flex-col
                ...
                group-hover:opacity-100 transition flex items-center gap-2">
                    ...
                    <div className="flex flex-col items-end w-32 text-sm">
                        ...
                        rounded-lg shadow-md mt-2 py-1 z-10`}>
                            ...
                            onClick={()=> navigator.share({url: gen.generatedImage 
                            || gen.generatedVideo, title: gen.productName, text:
